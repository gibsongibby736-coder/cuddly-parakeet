...
// ══════════════════════════════════════════════
//  SHADOW AI — WhatsApp Bot v14 (بدون قيود)
//  يرد في جميع المجموعات التي ينضم إليها
// ══════════════════════════════════════════════
...
async function startBot() {
  ...
  console.log('🌍 البوت سيرد في جميع المجموعات التي ينضم إليها');
  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      try {
        ...
        // ✅ لا توجد أي قيود — البوت يرد في كل المجموعات
